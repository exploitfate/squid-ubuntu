...
cp client_side_request.cc.patch build/squid3/client_side_request.cc.patch
...
wget http://http.debian.net/debian/pool/main/s/squid3/squid3_3.5.23-5+deb9u1.debian.tar.xz
...
# disable check for host header forgery (you should NEVER do this!)
patch squid3-3.5.23/src/client_side_request.cc < ../../client_side_request.cc.patch
